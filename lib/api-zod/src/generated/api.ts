...
export const LoginResponse = zod.object({
  ...
  "pendingEmailRequestedAt": zod.string().nullish()
})
})
...
export const RequestEmailChangeResponse = zod.object({
  "ok": zod.boolean()
})
...
export const ApproveUserEmailChangeParams = zod.object({
  "id": zod.coerce.string()
})

export const ApproveUserEmailChangeResponse = zod.object({
  "id": zod.string(),
  "email": zod.string(),
  "firstName": zod.string(),
  "lastName": zod.string(),
...
export const RejectUserEmailChangeParams = zod.object({
  "id": zod.coerce.string()
})
...
export const ListOutcomesQueryParams = zod.object({
  ...
  "patientId": zod.coerce.string().optional(),
  "programId": zod.coerce.string().optional(),
  "outcomeMetricId": zod.coerce.string().optional()
})
...
export const ListOutcomesResponse = zod.object({
  ...
  "targetAchieved": zod.boolean().optional(),
...
export const CreateOutcomeBody = zod.object({
  ...
  "currentValue": zod.number(),
  "targetValue": zod.number(),
  "measuredAt": zod.coerce.date().optional(),
  "notes": zod.string().optional()
})
...
export const UpdateOutcomeBody = zod.object({
  "outcomeMetricId": zod.string().optional(),
...
export const DeleteOutcomeParams = zod.object({
  "id": zod.coerce.string()
})


export const ListOutcomeMetricsQueryParams = zod.object({
  "page": zod.coerce.number().optional(),
  "limit": zod.coerce.number().optional(),
  "inactive": zod.coerce.boolean().optional()
})

export const ListOutcomeMetricsResponse = zod.object({
  "data": zod.array(zod.object({
  "id": zod.string(),
  "tenantId": zod.string(),
  "code": zod.string(),
...
export const CreateOutcomeMetricBody = zod.object({
  "code": zod.string(),
  "name": zod.string(),
  "category": zod.string(),
  "unit": zod.string(),
...
export const GetOutcomeMetricParams = zod.object({
  "id": zod.coerce.string()
})

export const GetOutcomeMetricResponse = zod.object({
  "id": zod.string(),
  "tenantId": zod.string(),
  "code": zod.string(),
  "name": zod.string(),
...
export const UpdateOutcomeMetricParams = zod.object({
  "id": zod.coerce.string()
})

export const UpdateOutcomeMetricBody = zod.object({
  "code": zod.string().optional(),
  "name": zod.string().optional(),
  "category": zod.string().optional(),
  "unit": zod.string().optional(),
...
export const UpdateOutcomeMetricResponse = zod.object({
  "id": zod.string(),
  "tenantId": zod.string(),
  "code": zod.string(),
  "name": zod.string(),
...
export const DeleteOutcomeMetricParams = zod.object({
  "id": zod.coerce.string()
})
...
export const ListRiskScoresResponse = zod.object({
  ...
  "lastCalculatedAt": zod.coerce.date().nullish(),
  "clinic": zod.object({
  "id": zod.string().optional(),
  "name": zod.string().optional()
}).nullish(),
...
export const RecalculateAllRiskScoresResponse = zod.object({
...
export const CalculatePatientRiskScoreParams = zod.object({
  "patientId": zod.coerce.string()
})

export const CalculatePatientRiskScoreResponse = zod.object({
  "id": zod.string(),
  "firstName": zod.string(),
  "lastName": zod.string(),
  "nhsNumber": zod.string().nullish(),
