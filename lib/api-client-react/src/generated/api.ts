...
export const getListFilesUrl = (params?: ListFilesParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/api/api/files?${stringifiedParams}` : `/api/api/files`
}
...
export const getDownloadFileUrl = (fileKey: string,) => {
  ...
  return `/api/api/files/${fileKey}/download`
}
...
export const getDownloadFileQueryKey = (fileKey: string,) => {
    return [
    `/api/api/files/${fileKey}/download`
    ] as const;
    }
...
export const getImportPatientsUrl = () => {
  ...
  return `/api/api/import/patients`
}
